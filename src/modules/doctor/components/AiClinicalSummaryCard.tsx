...
export const AiClinicalSummaryCard: React.FC<AiClinicalSummaryCardProps> = ({
  ...
  return (
    <BorderBeam size="md" colorVariant="colorful">
      <div className="relative bg-gradient-to-r from-slate-900 via-indigo-950 to-blue-950 border border-indigo-500/30 shadow-xl shadow-indigo-950/40 rounded-3xl p-6 text-white overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        {/* Mascot UI */}
        <div className="shrink-0 self-center md:self-auto flex items-center justify-center pt-2 md:pt-0">
          <Mascot
