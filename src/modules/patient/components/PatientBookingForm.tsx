      ...
      <div className="text-white rounded-[calc(2rem-0.625rem)] flex flex-col h-auto relative z-10">
        ...
        <div className="relative z-10 flex flex-col w-full h-full">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5 flex flex-col">
            ...
            {/* KHUNG 2: VẤN ĐỀ SỨC KHỎE CẦN KHÁM */}
            <div className="bg-white/5 p-4.5 rounded-xl border border-white/10 space-y-3 font-sans">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg bg-violet-500 hover:bg-violet-600 disabled:bg-white/20 disabled:cursor-not-allowed text-white font-bold text-xs transition-all flex items-center gap-1.5 shrink-0 cursor-pointer border-none shadow-sm"
                >
                  {isAISuggesting
              ...
              <textarea
                placeholder="Mô tả ngắn gọn triệu chứng hoặc nhu cầu khám bệnh của bạn... (VD: Bé 3 tuổi sốt cao, đau bụng...)"
                rows={2.5}
            ...
            {/* KHUNG 3: THÔNG TIN CHUYÊN KHOA & BÁC SĨ */}
