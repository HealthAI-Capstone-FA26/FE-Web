...
export const Badge: React.FC<BadgeProps> = ({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 border font-medium transition-all whitespace-nowrap shrink-0 ${variantStyles[variant]} ${sizeStyles[size]} ${className}`}
    >
      {renderIcon()}
      <span>{children}</span>
    </span>
